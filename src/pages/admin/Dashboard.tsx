    ...
    <div className="min-h-screen bg-bg-main text-text-main pb-20">
      ...
      <div className="px-6 grid grid-cols-1 gap-4 max-w-md mx-auto">
        ...
        <div className="grid grid-cols-2 gap-4">
          <Link to="/admin/members" className="bg-white p-6 rounded-2xl flex flex-col items-center justify-center border border-gray-100 shadow-sm hover:shadow-md hover:border-primary/20 transition active:scale-[0.98]">
             <div className="bg-emerald-50 p-3 rounded-xl text-emerald-600 mb-3">
               <UserCheck size={24} />
             </div>
             <div className="text-center">
               <div className="font-bold text-text-main">ユーザー管理</div>
               <div className="text-text-sub text-xs">登録数・ポイント調整</div>
             </div>
          </Link>
          ...
          <Link to="/admin/live-schedule" className="bg-white p-6 rounded-2xl flex flex-col items-center justify-center border border-gray-100 shadow-sm hover:shadow-md hover:border-primary/20 transition active:scale-[0.98]">
            <div className="bg-blue-50 p-3 rounded-xl text-blue-600 mb-3">
              <CalendarDays size={24} />
            </div>
            <div className="text-center">
              <div className="font-bold text-text-main">ライブ予定</div>
              <div className="text-text-sub text-xs">スケジュール管理</div>
            </div>
          </Link>

          <Link to="/admin/trophies" className="bg-white p-6 rounded-2xl flex flex-col items-center justify-center border border-gray-100 shadow-sm hover:shadow-md hover:border-primary/20 transition active:scale-[0.98]">
            <div className="bg-orange-50 p-3 rounded-xl text-orange-600 mb-3">
              <Medal size={24} />
            </div>
            <div className="text-center">
          ...
          <Link to="/admin/live-announcements" className="bg-white p-6 rounded-2xl flex flex-col items-center justify-center border border-gray-100 shadow-sm hover:shadow-md hover:border-primary/20 transition active:scale-[0.98]">
            <div className="bg-rose-50 p-3 rounded-xl text-rose-600 mb-3">
              <BellRing size={24} />
            </div>
            <div className="text-center">
