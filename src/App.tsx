...
import { UserWebsiteLink } from './pages/user/WebsiteLink';
import { GroupProfile } from './pages/user/GroupProfile';
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/user/link" element={<ProtectedUserRoute><UserWebsiteLink /></ProtectedUserRoute>} />
        <Route path="/user/groups/:groupId/profile" element={<ProtectedUserRoute><GroupProfile /></ProtectedUserRoute>} />
        ...
        <Route path="/admin/levels" element={<ProtectedAdminRoute><LevelConfigPage /></ProtectedAdminRoute>} />
